//docFormPreFill/OrgAllUserPreFillFields.js
...
import { WsOrgUsers, WsGetPreFillKeysByType } from "../../configs/WebService";
...
const OrgAllUserPreFillFields = () => {
  ...
  const getOrgUsers = () => {
    axios
      .get(WsOrgUsers + "/" + userData.id + "/" + userData.org.id, {
        headers: apiKeyHeader(),
      })
      .then((response) => {
        const responseData = response.data;
        ...
        <div className="right_col" role="main">
          <div className="page-title">
            <div className="title_left">
              <h3>Org User Prefill Field(s)</h3>
            </div>
            ...
            <div className="col-md-12 col-sm-12  ">
              <div className="x_panel">
                <div className="x_title">
                  <h2>Org User Prefill Fields(s)</h2>
                ...
                <div className="x_content">
                  ...
                  {preFillFields != undefined && preFillFields.length > 0 ? (
                    <>
                      <div className="row">
                        <label className="col-2 label">Select User</label>
                      ...
                      {orgUser != undefined ? (
                        ...
                        <b>
                          <br />
                          Select user to set PrefillField Values
                        </b>
                      )}
                    </>
                  ) : (
                    <>There is No PrefilledFields Data</>
                  )}
                </div>
              </div>
            </div>
...
export default OrgAllUserPreFillFields;
