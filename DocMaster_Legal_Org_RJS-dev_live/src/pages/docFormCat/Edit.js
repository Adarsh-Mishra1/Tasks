...
import { WSUpdateDocFormCategory } from "../../configs/WebService"; //Java

// import { WSUpdateDocFormCategory } from "../../configs/WebServiceNodeJS"; //Node
...
const Add = () => {
  ...
  const category2edit = location.state.category2edit;
  const [category, setCategory] = useState(category2edit.category);
  const [description, setDescription] = useState(category2edit.description);

  function onSubmitHandler(e) {
    e.preventDefault();

    if (category.length >= 3) {
      processdToEditCategory();
    } else {
      alert("Enter Category");
    }
  }
  function processdToEditCategory() {
    /*[Raw-JSON]
recId:number,
userId:number,
orgId:number, 
...
*/
    ...
    console.log("processdToEditCategory_params2post", params2post);

    axios
      .post(WSUpdateDocFormCategory, params2post, {
        headers: apiKeyHeader(),
      })
      .then((response) => {
        const responseData = response.data;
        console.log("processdToEditCategory_responseData", responseData);
      ...
      .catch((error) => {
        console.error("processdToEditCategory_error", error);
