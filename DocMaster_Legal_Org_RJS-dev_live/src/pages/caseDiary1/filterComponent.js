...
function FilterComponent({
  ...
  return (
    <div className="mb-3 d-flex gap-5 filter-cmpnt">
      <div className="d-flex gap-2 my-1">
        <label className="align-content-center" style={{width:'70px'}}>Filter By:</label>
        <select
          className="  "
      ...
      {selectedDropdown && selectedDropdown !== null && (
        <div className="d-flex gap-2 my-1">
          <label className="align-content-center" style={{ width:'320px'}}>
