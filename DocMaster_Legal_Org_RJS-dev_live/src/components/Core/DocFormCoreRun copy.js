  ...
  */
  ...
  nodeApi = async (body) => {
    ...
    try {
      ...
      this.setState((prev) => ({
        responseResult: [...data],
        // responseResult: [...prev.responseResult, ...data],
      }));
    } catch (error) {
  ...
  async askiAILeft() {
    ...
    console.log("aiQuery_732: ", aiQuery);
          ...
          <div className="">
                    ...
                    <>
                      <ReactToPrint
                        ...
                        pageStyle={
                          ...
                          this.state.pageType +
                          "; margin: " +
                          Number(this.state.printMarginTop) * 0.3937 +
                          "in " +
                          Number(this.state.printMarginRight) * 0.3937 +
                          "in " +
                          Number(this.state.printMarginBottom) * 0.3937 +
                          "in " +
                          Number(this.state.printMarginLeft) * 0.3937 +
                          "in!important }}"
                        }
                        trigger={() => {
            ...
            <div className="formFieldAndTemplateContainer">
              <div className="d-flex">
                <div id="docFormInputFields" className="generalUserInputField ">
                  {/* {(this.state.formData.telephonetypes0 === "Single" ||
                    (this.state.formData.telephonetypes0 === "Multiple" &&
                      this.state.formData.numbertelephonetypes00 > 0) ||
                    this.state.formData.numbertelephoneexpenses00 > 0) && (
                  ...
                  {this.props.clientFormType === "drftng" && (
                    <button
                      className="btn-outline-primary btn my-2"
                      style={{
                ...
                >
                  ...
                  {this.props.clientFormType === "judgement" && (
                    <Table response={this.state.responseResult} />
                  )}
                </div>
              </div>
            </div>
