...
const UsageStatsByDocForm = () => {
  ...
  function getStatData() {
    axios
      .get(WsGetOrgDocFormUsageStats + "/" + userData.org.id + "/0", {
    ...
    <div className="row statBox">
      <div className="col-md-12">
        <i
          data-tip="View"
          title="View"
          key={`UsageStatsByDocFormView_i`}
          className="fa fa-eye mx-2"
          style={{ color: "blue", cursor: "pointer" }}
          aria-hidden="true"
          onClick={() => navigate("/docFormUsageStats?type=0")}
        />
        <i
          data-tip="Reload"
          title="Reload"
          key={`UsageStatsByDocFormRld_i`}
        ...
        {showChart ? (
          <Bar
            data={{
              ...
              datasets: [
                {
                  label: "DocForms Usage by DocForm",
                  data: data,
...
export default UsageStatsByDocForm;
