!(function (t, e) {
  ...
  "function" == typeof define && define.amd
    ...
    : "object" == typeof module && module.exports
      ? (module.exports = e())
      : ((t.AnchorJS = e()), (t.anchors = new t.AnchorJS()));
})(this, function () {
  "use strict";
  return function (t) {
    function h(t) {
      (t.icon = t.hasOwnProperty("icon") ? t.icon : ""),
        ...
        (t.truncate = t.hasOwnProperty("truncate")
          ? Math.floor(t.truncate)
          : 64);
    }
    function d(t) {
      var e;
    ...
    (this.options = t || {}),
      ...
      (this.add = function (t) {
        ...
        if (
          (h(this.options),
          "touch" === (u = this.options.visible) &&
            (u = this.isTouchDevice() ? "always" : "hover"),
          t || (t = "h2, h3, h4, h5, h6"),
          0 === (e = d(t)).length)
        )
          return this;
        for (
          (function () {
            if (null === document.head.querySelector("style.anchorjs")) {
              ...
              (e.className = "anchorjs"),
                ...
                void 0 ===
                (t = document.head.querySelector('[rel="stylesheet"], style'))
                  ? document.head.appendChild(e)
                  : document.head.insertBefore(e, t),
                e.sheet.insertRule(
          ...
          if (this.hasAnchorJSLink(e[r])) f.push(r);
            ...
            if (e[r].hasAttribute("id")) i = e[r].getAttribute("id");
              ...
              for (
                c = l = this.urlify(e[r].textContent), a = 0;
                void 0 !== A && (c = l + "-" + a),
                  (a += 1),
                  -1 !== (A = o.indexOf(c));
            ...
            i.replace(/-/g, " "),
              ...
              "always" === u && (s.style.opacity = "1"),
              "" === this.options.icon &&
                ((s.style.font = "1em/1 anchorjs-icons"),
                "left" === this.options.placement &&
                  (s.style.lineHeight = "inherit")),
              "left" === this.options.placement
                ? ((s.style.position = "absolute"),
                  (s.style.marginLeft = "-1em"),
                  (s.style.paddingRight = "0.5em"),
                  e[r].insertBefore(s, e[r].firstChild))
                : ((s.style.paddingLeft = "0.375em"), e[r].appendChild(s));
          }
        for (r = 0; r < f.length; r++) e.splice(f[r] - r, 1);
        return (this.elements = this.elements.concat(e)), this;
      }),
      (this.remove = function (t) {
        for (var e, n, o = d(t), i = 0; i < o.length; i++)
      ...
      (this.urlify = function (t) {
        return (
          this.options.truncate || h(this.options),
          t
            .trim()
            .replace(/\'/gi, "")
            .replace(/[& +$,:;=?@"#{}|^~[`%!'<>\]\.\/\(\)\*\\\n\t\b\v]/g, "-")
      ...
      (this.hasAnchorJSLink = function (t) {
        var e =
            t.firstChild &&
            -1 <
              (" " + t.firstChild.className + " ").indexOf(" anchorjs-link "),
          n =
            t.lastChild &&
            -1 < (" " + t.lastChild.className + " ").indexOf(" anchorjs-link ");
        return e || n || !1;
      });
  };
});
  ...
  return (function (n) {
    ...
    function (t, e, n) {
      ...
      var o,
        ...
        A = n(2),
        a = (o = A) && o.__esModule ? o : { default: o };
      var l = (function () {
        function e(t) {
          !(function (t, e) {
            if (!(t instanceof e))
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n) {
        ...
        if (f.string(t))
          return (o = t), (i = e), (r = n), h(document.body, o, i, r);
        throw new TypeError(
...
!(function (t, e) {
  ...
  function d() {
    for (
      var t = [].slice
          .call(this.querySelectorAll(f.INPUT))
          .filter(function (t) {
  ...
  return {
    init: function (t, e) {
      ...
      for (var s = 0, u = A.length; s < u; s++)
        A[s].addEventListener(y, d),
          Object.defineProperty(A[s], p, { value: !0, writable: !0 });
    },
    destroy: function () {
      for (
        var t = [].slice
            .call(document.querySelectorAll(f.FORM))
            .filter(function (t) {
              return !!t.bsCustomFileInput;
            }),
          e = [].slice
            .call(document.querySelectorAll(f.INPUT))
            .filter(function (t) {
              return !!t.bsCustomFileInput;
            }),
          n = 0,
      ...
      for (var r = 0, A = t.length; r < A; r++)
        t[r].removeEventListener(y, d), (t[r][p] = void 0);
    },
  };
});
/*!
...
(function (i) {
  ...
  i(function () {
    ...
    i(".toast").toast({ autohide: false }).toast("show");
    i(".tooltip-test").tooltip();
    i(".popover-test").popover();
    i('.bd-example-indeterminate [type="checkbox"]').prop(
      "indeterminate",
      true,
    );
