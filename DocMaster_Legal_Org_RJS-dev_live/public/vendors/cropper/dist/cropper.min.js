  ...
  (v.prototype = {
    ...
    bind: function () {
      ...
      t.isFunction(i.cropstart) && e.on(N, i.cropstart),
        ...
        t.isFunction(i.crop) && e.on(Z, i.crop),
        t.isFunction(i.zoom) && e.on(K, i.zoom),
        s.on(z, t.proxy(this.cropStart, this)),
        i.zoomable && i.zoomOnWheel && s.on(P, t.proxy(this.wheel, this)),
        i.toggleDragModeOnDblclick && s.on(U, t.proxy(this.dblclick, this)),
        x
          .on(O, (this._cropMove = a(this.cropMove, this)))
          .on(E, (this._cropEnd = a(this.cropEnd, this))),
    ...
    unbind: function () {
      ...
      t.isFunction(i.cropstart) && e.off(N, i.cropstart),
        ...
        t.isFunction(i.crop) && e.off(Z, i.crop),
        t.isFunction(i.zoom) && e.off(K, i.zoom),
        s.off(z, this.cropStart),
        i.zoomable && i.zoomOnWheel && s.off(P, this.wheel),
        i.toggleDragModeOnDblclick && s.off(U, this.dblclick),
        x.off(O, this._cropMove).off(E, this._cropEnd),
