...
var mode = argv.m || "all";
var configPath =
    mode === "all" ? "config/echarts.js" : "config/echarts." + mode + ".js";
var outPath =
    mode === "all" ? "../dist/echarts.js" : "../dist/echarts." + mode + ".js";
...
fs.writeFileSync(
    outPath,
    [startCode, nutCode, mainCode, endCode].join("\n"),
    "utf-8",
);
fs.writeFileSync(
