...
define(function (require) {
    ...
    var Float64Array =
        typeof globalObj.Float64Array === UNDEFINED
            ? Array
            : globalObj.Float64Array;
    var Int32Array =
        typeof globalObj.Int32Array === UNDEFINED
            ? Array
            : globalObj.Int32Array;
    ...
    var transferImmuProperties = function (a, b) {
        zrUtil.each(
            IMMUTABLE_PROPERTIES.concat(b.__wrappedMethods || []),
            function (propName) {
        ...
        if (stack) {
            ...
            if (dimensionInfo && dimensionInfo.stackable) {
                ...
                while (stackedOn) {
                    ...
                    if (
                        (value >= 0 && stackedValue > 0) || // Positive stack
    ...
    listProto.cloneShallow = function () {
        var dimensionInfoList = zrUtil.map(
            this.dimensions,
    ...
    listProto.wrapMethod = function (methodName, injectFunction) {
        ...
        this[methodName] = function () {
            ...
            return injectFunction.apply(
                this,
                [res].concat(zrUtil.slice(arguments)),
            );
        };
    };
