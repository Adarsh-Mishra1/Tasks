define(function (require) {
     ...
     */
    modelUtil.createLinkedNodesFinder = function (
        forEachNode,
        forEachEdgeType,
        edgeIdGetter,
    ) {
        ...
        function isLinked(node, result) {
            ...
            forEachEdgeType(function (edgeType) {
                zrUtil.each(
                    edgeIdGetter(node, edgeType) || [],
                    function (edgeId) {
                        result.records[edgeType.name][edgeId] &&
                            (hasLink = true);
                    },
                );
            });
    ...
    modelUtil.defaultEmphasis = function (opt, subOpts) {
        if (opt) {
            ...
            zrUtil.each(subOpts, function (subOptName) {
                var val = zrUtil.retrieve(
                    emphasisOpt[subOptName],
                    normalOpt[subOptName],
                );
                if (val != null) {
