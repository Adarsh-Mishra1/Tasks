...
define(function (require) {
    ...
    var GlobalModel = Model.extend({
        ...
        resetOption: function (type) {
            ...
            if (!type || type === "recreate" || type === "timeline") {
                ...
                timelineOption &&
                    (this.mergeOption(timelineOption), (optionChanged = true));
            }

            if (!type || type === "recreate" || type === "media") {
                var mediaOptions = optionManager.getMediaOption(
                    this,
                    this._api,
                );
        ...
        mergeOption: function (newOption) {
            ...
            function visitComponent(mainType, dependencies) {
                var newCptOptionList = modelUtil.normalizeToArray(
                    newOption[mainType],
                );
                ...
                each(
                    ...
                    function (resultItem, index) {
                        ...
                        if (!newCptOption) {
                            ...
                            if (
                                componentModel &&
                                componentModel instanceof ComponentModelClass
                            ) {
                ...
                if (mainType === "series") {
                    this._seriesIndices = createSeriesIndices(
                        componentsMap.series,
                    );
                }
            }
        },
        ...
        queryComponents: function (condition) {
            ...
            if (index != null) {
                ...
                result = filter(cpts, function (cpt) {
                    return (
                        (isNameArray && indexOf(name, cpt.name) >= 0) ||
    ...
    function createSeriesIndices(seriesModels) {
        return (
            map(seriesModels, function (series) {
