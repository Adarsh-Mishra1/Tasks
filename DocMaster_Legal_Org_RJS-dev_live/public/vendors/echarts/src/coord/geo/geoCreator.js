    ...
    var geoCreator = {
        ...
        create: function (ecModel, api) {
            ...
            zrUtil.each(mapModelGroupBySeries, function (mapSeries, mapType) {
                ...
                var nameMapList = zrUtil.map(
                    mapSeries,
                    function (singleMapSeries) {
                ...
                geo.zoomLimit = zrUtil.retrieve.apply(
                    null,
                    zrUtil.map(mapSeries, function (singleMapSeries) {
