...
define(function (require) {
    ...
    echartsProto.dispatchAction = function (payload, silent) {
        ...
        if (actionWrap) {
            ...
            var eventObjBatch = [];
            var eventObj;
            var isHighlightOrDownplay =
                payload.type === "highlight" || payload.type === "downplay";
            for (var i = 0; i < payloads.length; i++) {
                ...
                isHighlightOrDownplay &&
                    updateMethods[updateMethod].call(this, batchItem);
            }
    ...
    function prepareView(type, ecModel) {
        ...
        ecModel[isComponent ? "eachComponent" : "eachSeries"](function (
            componentType,
            model,
        ) {
            if (isComponent) {
                ...
                this._zr.on(
                    ...
                    function (e) {
                        ...
                        if (el && el.dataIndex != null) {
                            var dataModel =
                                el.dataModel ||
                                ecModel.getSeriesByIndex(el.seriesIndex);
                            var params =
                                (dataModel &&
        ...
        zrUtil.each(eventActionMap, function (actionType, eventType) {
            chart._messageCenter.on(eventType, function (event) {
                if (
                    ...
                    chart[STATUS_KEY] !== STATUS_PENDING
                ) {
    ...
    echarts.registerProcessor = function (stage, processorFunc) {
        ...
        var funcs =
            dataProcessorFuncs[stage] || (dataProcessorFuncs[stage] = []);
    ...
    echarts.registerVisualCoding(
        "echarts",
        zrUtil.curry(require("./visual/seriesColor"), "", "itemStyle"),
    );
