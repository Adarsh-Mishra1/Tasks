define(function (require) {
    ...
    var markLineTransform = function (seriesModel, coordSys, mlModel, item) {
        ...
        if (
            ...
            if (item.yAxis != null || item.xAxis != null) {
                ...
                var axisInfo = markerHelper.getAxisInfo(
                    item,
                    data,
                    coordSys,
                    seriesModel,
    ...
    function ifMarkLineHasOnlyDim(dimIndex, fromCoord, toCoord, coordSys) {
        ...
        return (
            isInifinity(fromCoord[otherDimIndex]) &&
            isInifinity(toCoord[otherDimIndex]) &&
    ...
    function markLineFilter(coordSys, item) {
        ...
        return (
            markerHelper.dataFilter(coordSys, item[0]) &&
            ...
            if (coordSys.type === "cartesian2d") {
                ...
                if (isInifinity(data.get(dims[0], idx))) {
                    point[0] = xAxis.toGlobalCoord(
                        xAxis.getExtent()[isFrom ? 0 : 1],
                    );
                } else if (isInifinity(data.get(dims[1], idx))) {
                    point[1] = yAxis.toGlobalCoord(
                        yAxis.getExtent()[isFrom ? 0 : 1],
                    );
                }
            }
        }
    ...
    var markLineFormatMixin = {
        formatTooltip: function (dataIndex) {
            ...
            var formattedValue = zrUtil.isArray(value)
                ? zrUtil.map(value, addCommas).join(", ")
                : addCommas(value);
    ...
    require("../../echarts").extendComponentView({
        ...
        render: function (markLineModel, ecModel, api) {
            ...
            ecModel.eachSeries(function (seriesModel) {
                ...
                mlModel &&
                    this._renderSeriesML(seriesModel, mlModel, ecModel, api);
            }, this);
        ...
        _renderSeriesML: function (seriesModel, mlModel, ecModel, api) {
            ...
            function updateDataVisualAndLayout(
                ...
                data.setItemVisual(idx, {
                    ...
                    color:
                        itemModel.get("itemStyle.normal.color") ||
    ...
    function createList(coordSys, seriesModel, mlModel) {
        ...
        var optData = zrUtil.map(
            mlModel.get("data"),
            zrUtil.curry(markLineTransform, seriesModel, coordSys, mlModel),
        );
        if (coordSys) {
