...
define(function (require) {
    ...
    var VisualMapModel = echarts.extendComponentModel({
                    ...
                    function (state) {
                        ...
                        each(
                            ...
                            function (visualData, visualType) {
                                ...
                                fillVisualOption &&
                                    fillVisualOption.call(
                                        this,
                                        mappingOption,
                                        state,
                                    );
                                mappings[visualType] = new VisualMapping(
                                    mappingOption,
                                );
                                ...
                                if (
                                    ...
                                    mappings.__hidden.__alphaForOpacity =
                                        new VisualMapping(mappingOption);
                                }
                            },
                            this,
                        );
        ...
        completeVisualOption: function () {
            ...
            var controller =
                thisOption.controller || (thisOption.controller = {});
            ...
            function completeController(controller) {
                var symbolExists =
                    (controller.inRange || {}).symbol ||
                    (controller.outOfRange || {}).symbol;
                var symbolSizeExists =
                    (controller.inRange || {}).symbolSize ||
                ...
                each(
                    ...
                    function (state) {
                        ...
                        if (visuals.symbol == null) {
                            visuals.symbol =
                                (symbolExists && zrUtil.clone(symbolExists)) ||
        ...
        eachTargetSeries: function (callback, context) {
            zrUtil.each(
                ...
                function (seriesIndex) {
                    callback.call(
                        context,
                        this.ecModel.getSeriesByIndex(seriesIndex),
                    );
                },
                this,
            );
