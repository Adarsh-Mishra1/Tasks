define(function (require) {
    ...
    var SliderZoomView = DataZoomView.extend({
        ...
        render: function (dataZoomModel, ecModel, api, payload) {
            ...
            this._halfHandleSize = mathRound(
                dataZoomModel.get("handleSize") / 2,
            );
                ...
                zrUtil.each(
                    ...
                    function (seriesModel) {
                        ...
                        result = {
                            ...
                            otherDim: otherDim,
                            otherAxisInverse:
                                seriesModel.coordinateSystem.getOtherAxis(
                                    thisAxis,
                                ).inverse,
                        };
                    },
        ...
        _updateDataInfo: function () {
                ...
                dataZoomModel.eachTargetAxis(function (dimNames, axisIndex) {
                    ...
                    if (!dataInterval) {
                        dataInterval = dataZoomModel
                            .getAxisProxy(dimNames.name, axisIndex)
                            .getDataValueWindow();
                        axis = this.ecModel.getComponent(
                            dimNames.axis,
                            axisIndex,
                        ).axis;
                    }
            ...
            function setLabel(handleIndex) {
                ...
                var barTransform = graphic.getTransform(
                    displaybles.handles[handleIndex],
                    this.group,
                );
                ...
                handleLabels[handleIndex].setStyle({
                    ...
                    y: textPoint[1],
                    textVerticalAlign:
                        orient === HORIZONTAL ? "middle" : direction,
        ...
        _findCoordRect: function () {
            ...
            if (targetInfo.cartesians.length) {
                rect =
                    targetInfo.cartesians[0].model.coordinateSystem.getRect();
            } else {
                // Polar
                // FIXME
                // 暂时随便写的
