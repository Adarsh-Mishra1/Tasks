define(function (require) {
    ...
    require("../../echarts").extendComponentView({
        ...
        render: function (angleAxisModel, ecModel) {
            ...
            var polarModel = ecModel.getComponent(
                "polar",
                angleAxisModel.get("polarIndex"),
            );
        ...
        _axisTick: function (angleAxisModel, polar, ticksAngles, radiusExtent) {
            ...
            var tickLen =
                (tickModel.get("inside") ? -1 : 1) * tickModel.get("length");
            ...
            var lines = zrUtil.map(ticksAngles, function (tickAngle) {
                return new graphic.Line({
                    shape: getAxisLineShape(
                        polar,
                        radiusExtent[1],
                        radiusExtent[1] + tickLen,
                        tickAngle,
                    ),
                });
            });
            this.group.add(
                graphic.mergePath(lines, {
        ...
        _axisLabel: function (
            ...
            for (var i = 0; i < ticksAngles.length; i++) {
                ...
                var labelTextAlign =
                    Math.abs(p[0] - cx) / r < 0.3
                        ? "center"
                        : p[0] > cx
                          ? "left"
                          : "right";
                var labelTextBaseline =
                    Math.abs(p[1] - cy) / r < 0.3
                        ? "middle"
                        : p[1] > cy
                          ? "top"
                          : "bottom";
        ...
        _splitLine: function (
            ...
            lineColors =
                lineColors instanceof Array ? lineColors : [lineColors];
            ...
            for (var i = 0; i < splitLines.length; i++) {
                this.group.add(
                    graphic.mergePath(splitLines[i], {
        ...
        _splitArea: function (
            ...
            areaColors =
                areaColors instanceof Array ? areaColors : [areaColors];
            ...
            for (var i = 0; i < splitAreas.length; i++) {
                this.group.add(
                    graphic.mergePath(splitAreas[i], {
                        style: zrUtil.defaults(
                            {
