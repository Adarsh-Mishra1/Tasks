define(function (require) {
    ...
    var builders = {
        ...
        axisLabel: function () {
            ...
            var labelLayout = innerTextLayout(
                opt,
                labelRotation,
                opt.labelDirection,
            );
            ...
            for (var i = 0; i < ticks.length; i++) {
                ...
                var textEl = new graphic.Text({
                    style: {
                        text: labels[i],
                        textAlign:
                            itemTextStyleModel.get("align", true) ||
                            labelLayout.textAlign,
                        textVerticalAlign:
                            itemTextStyleModel.get("baseline", true) ||
                            labelLayout.verticalAlign,
                        textFont: itemTextStyleModel.getFont(),
                        fill:
                            typeof textColor === "function"
                                ? textColor(labelBeforeFormat)
                                : textColor,
                    },
                    position: pos,
            ...
            if (axis.type !== "category") {
                ...
                if (
                    axisModel.getMin ? axisModel.getMin() : axisModel.get("min")
                ) {
                ...
                if (
                    axisModel.getMax ? axisModel.getMax() : axisModel.get("max")
                ) {
     ...
     * @static
     */
    var getInterval = (AxisBuilder.getInterval = function (
        model,
        labelInterval,
    ) {
