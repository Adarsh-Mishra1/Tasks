define(function (require) {
    ...
    var AxisView = require("../../echarts").extendComponentView({
        ...
        _buildSelectController: function (
            axisGroup,
            areaSelectStyle,
            axisModel,
            api,
            ...
            if (!selectController) {
                selectController = this._selectController =
                    new SelectController("line", api.getZr(), areaSelectStyle);

                selectController.on(
                    "selected",
                    zrUtil.bind(this._onSelected, this),
                );
            }
            ...
            var ranges = zrUtil.map(
                axisModel.activeIntervals,
                function (interval) {
                    return [
