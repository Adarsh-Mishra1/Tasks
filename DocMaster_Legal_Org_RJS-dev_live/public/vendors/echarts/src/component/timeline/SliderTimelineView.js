    ...
    return TimelineView.extend({
        ...
        _layout: function (timelineModel, api) {
            ...
            var labelAlignMap = {
                horizontal: "center",
                vertical:
                    labelPosOpt >= 0 || labelPosOpt === "+" ? "left" : "right",
            };

            var labelBaselineMap = {
                horizontal:
                    labelPosOpt >= 0 || labelPosOpt === "+" ? "top" : "bottom",
                vertical: "middle",
            };
            var rotationMap = {
                horizontal: 0,
            ...
            // Position
            var mainLength =
                orient === "vertical" ? viewRect.height : viewRect.width;
            ...
            var showPlayBtn =
                showControl && controlModel.get("showPlayBtn", true);
            var showPrevBtn =
                showControl && controlModel.get("showPrevBtn", true);
            var showNextBtn =
                showControl && controlModel.get("showNextBtn", true);
            var xLeft = 0;
            ...
            if (controlPosition === "left" || controlPosition === "bottom") {
                showPlayBtn &&
                    ((playPosition = [0, 0]), (xLeft += sizePlusGap));
                showPrevBtn &&
                    ((prevBtnPosition = [xLeft, 0]), (xLeft += sizePlusGap));
                showNextBtn &&
                    ((nextBtnPosition = [xRight - controlSize, 0]),
                    (xRight -= sizePlusGap));
            } else {
                // 'top' 'right'
                showPlayBtn &&
                    ((playPosition = [xRight - controlSize, 0]),
                    (xRight -= sizePlusGap));
                showPrevBtn &&
                    ((prevBtnPosition = [0, 0]), (xLeft += sizePlusGap));
                showNextBtn &&
                    ((nextBtnPosition = [xRight - controlSize, 0]),
                    (xRight -= sizePlusGap));
            }
        ...
        _position: function (layoutInfo, timelineModel) {
            ...
            function toBound(fromPos, from, to, dimIdx, boundIdx) {
                fromPos[dimIdx] +=
                    to[dimIdx][boundIdx] - from[dimIdx][boundIdx];
            }
        },
        ...
        _renderAxisTick: function (layoutInfo, group, axis, timelineModel) {
            ...
            each(
                ...
                function (value, dataIndex) {
                    ...
                    var hoverStyleModel =
                        itemModel.getModel("itemStyle.emphasis");
                    var symbolOpt = {
        ...
        _renderAxisLabel: function (layoutInfo, group, axis, timelineModel) {
            ...
            each(
                ticks,
                function (tick, dataIndex) {
                    if (axis.isLabelIgnored(dataIndex, labelInterval)) {
                        return;
                    }

                    var itemModel = data.getItemModel(dataIndex);
                    var itemTextStyleModel = itemModel.getModel(
                        "label.normal.textStyle",
                    );
                    var hoverTextStyleModel = itemModel.getModel(
                        "label.emphasis.textStyle",
                    );
                    ...
                    var textEl = new graphic.Text({
                        ...
                        position: [tickCoord, 0],
                        rotation:
                            layoutInfo.labelRotation - layoutInfo.rotation,
                        onclick: bind(this._changeTimeline, this, dataIndex),
                        silent: false,
                    });
                    ...
                    graphic.setHoverStyle(
                        textEl,
                        hoverTextStyleModel.getItemStyle(),
                    );
                },
                this,
            );
        ...
        _renderControl: function (layoutInfo, group, axis, timelineModel) {
            ...
            var itemStyle = timelineModel
                .getModel("controlStyle.normal")
                .getItemStyle();
            var hoverStyle = timelineModel
                .getModel("controlStyle.emphasis")
                .getItemStyle();
        ...
        _renderCurrentPointer: function (
            layoutInfo,
            group,
            axis,
            timelineModel,
