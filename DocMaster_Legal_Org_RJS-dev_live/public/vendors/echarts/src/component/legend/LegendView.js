            ...
            zrUtil.each(
                ...
                function (itemModel) {
                    ...
                    if (seriesModel) {
                        ...
                        var legendSymbolType =
                            data.getVisual("legendSymbol") || "roundRect";
                        ...
                        itemGroup
                            .on("click", curry(dispatchSelectAction, name, api))
                            .on(
                                "mouseover",
                                curry(
                        ...
                        ecModel.eachRawSeries(function (seriesModel) {
                            ...
                            if (seriesModel.legendDataProvider) {
                                ...
                                itemGroup
                                    .on(
                                        "click",
                                        curry(dispatchSelectAction, name, api),
                                    )
