define(function (require) {
        ...
        render: function (seriesModel, ecModel, api, payload) {
            ...
            data.eachItemGraphicEl(function (elGroup, idx) {
                ...
                elGroup.eachChild(function (child) {
                    child.useStyle(
                        zrUtil.extend(lineStyleModel.getLineStyle(), {
                            fill: null,
            ...
            // First create
            if (!this._data) {
                dataGroup.setClipPath(
                    createGridClipShape(coordSys, seriesModel, function () {
    ...
    function createGridClipShape(coordSys, seriesModel, cb) {
        ...
        var dim =
            parallelModel.get("layout") === "horizontal" ? "width" : "height";
