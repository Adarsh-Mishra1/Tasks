define(function (require) {
    ...
    piePieceProto._updateLabel = function (data, idx) {
        ...
        var labelPosition =
            labelModel.get("position") || labelHoverModel.get("position");

        labelText.setStyle(
            getLabelStyle(data, idx, "normal", labelModel, labelPosition),
        );
        ...
        labelText.hoverStyle = getLabelStyle(
            data,
            idx,
            "emphasis",
            labelHoverModel,
        ...
        _createClipPath: function (
            ...
            graphic.initProps(
                clipPath,
                {
                    shape: {
                        endAngle:
                            startAngle + (clockwise ? 1 : -1) * Math.PI * 2,
                    },
                },
                seriesModel,
                cb,
