define(function (require) {
        ...
        render: function (seriesModel, ecModel, api, payload) {
            ...
            var reRoot =
                payloadType === "treemapRootToNode" && targetInfo && thisStorage
                    ? {
                          rootNodeGroup:
                              thisStorage.nodeGroup[
                                  targetInfo.node.getRawIndex()
                              ],
        ...
        _doRender: function (containerGroup, seriesModel, reRoot) {
            ...
            function dualTravel(
                ...
                function processNode(newIndex, oldIndex) {
                    var thisNode =
                        newIndex != null ? thisViewChildren[newIndex] : null;
                    var oldNode =
                        oldIndex != null ? oldViewChildren[oldIndex] : null;

                    var group = doRenderNode(
                        thisNode,
                        oldNode,
                        parentGroup,
                        depth,
        ...
        _doAnimation: function (
            ...
            each(
                ...
                function (store, storageName) {
                    each(store, function (el, rawIndex) {
                        var last =
                            renderResult.lastsForAnimation[storageName][
                                rawIndex
                            ];
                        var target = {};
            ...
            function onClick(e) {
                ...
                if (node.getLayout().isLeafRoot) {
                    ...
                    if (nodeClick === "zoomToNode") {
                        ...
                        var itemModel = node.hostTree.data.getItemModel(
                            node.dataIndex,
                        );
                        var link = itemModel.get("link", true);
                        var linkTarget =
                            itemModel.get("target", true) || "blank";
    ...
    function renderNode(
        ...
        function giveGraphic(storageName, Ctor, depth, z) {
            var element =
                oldRawIndex != null && oldStorage[storageName][oldRawIndex];
        ...
        function prepareAnimationWhenNoOld(lasts, element, storageName) {
            ...
            if (parentNode && (!reRoot || reRoot.direction === "drillDown")) {
                ...
                var parentOldBg =
                    lastsForAnimation.background[parentNode.getRawIndex()];
