define(function (require) {
    ...
    return function (ecModel, payload) {
        ...
        ecModel.eachComponent(condition, function (seriesModel) {
            ...
            var levelItemStyles = zrUtil.map(
                tree.levelModels,
                function (levelModel) {
                    return levelModel
                        ? levelModel.get(ITEM_STYLE_NORMAL)
                        : null;
                },
            );
    ...
    function travelTree(
        ...
        var borderColorSaturation = nodeItemStyleModel.get(
    ...
    function calculateColor(visuals) {
        ...
        if (color) {
            ...
            var colorSaturation = getValueVisualDefine(
                visuals,
                "colorSaturation",
            );
            if (colorSaturation) {
    ...
    function mapVisual(nodeModel, visuals, child, index, mapping, seriesModel) {
        ...
        if (mapping) {
            ...
            var colorMappingBy =
                mappingType === "color" && mapping.__drColorMappingBy;
            var value =
