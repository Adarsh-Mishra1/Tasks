...
define(function (require) {
    ...
    function updateSymbolAndLabelBeforeLineUpdate() {
        ...
        if (symbolFrom) {
            ...
            symbolFrom.attr(
                "rotation",
                Math.PI / 2 - Math.atan2(tangent[1], tangent[0]),
            );
        ...
        if (!label.ignore) {
            ...
            label.attr({
                style: {
                    ...
                    textVerticalAlign:
                        label.__verticalAlign || textVerticalAlign,
    ...
    lineProto._createLine = function (lineData, idx) {
        ...
        zrUtil.each(
            ...
            function (symbolCategory) {
                ...
                this.add(symbol);
                this[makeSymbolTypeKey(symbolCategory)] =
                    lineData.getItemVisual(idx, symbolCategory);
            },
            this,
        );
