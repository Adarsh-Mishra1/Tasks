    ...
    return (function (t) {
        ...
        function (t, e, i) {
            ...
            (S.Group = i(27)),
                ...
                (S.applyTransform = function (t, e, i) {
                    return (
                        i && (e = b.invert([], e)), w.applyTransform([], t, e)
                    );
                }),
        ...
        function (t, e, i) {
            ...
            (o.prototype = {
                ...
                brush: function (t) {
                    ...
                    i.setScale(f[0], f[1]),
                        this.__dirtyPath || (c && !d && o)
                            ? ((i = this.path.beginPath(t)),
                              c &&
                                  !d &&
                                  (i.setLineDash(c), i.setLineDashOffset(u)),
        ...
        function (t, e, i) {
            ...
            (s.createNameEach = function (t, e) {
                ...
                (s.eachAxisDim = s.createNameEach(a, [
                    "axisIndex",
                    "axis",
                    "index",
                ])),
        ...
        function (t, e, i) {
            ...
            (_.prototype = {
                ...
                arc: function (t, e, i, n, r, o) {
                    return (
                        this.addData(l.A, t, e, i, i, n, r - n, 0, o ? 0 : 1),
        ...
        function (t, e, i) {
            ...
            (o.prototype = { constructor: o, type: "linear" }),
                n.inherits(o, r),
                (t.exports = o);
        },
        function (t, e, i) {
                ...
                t
                    ...
                    .update(function (o, a) {
                        ...
                        return r(t.getItemLayout(o))
                            ? (s ? s.updateData(t, o) : (s = new n(t, o)),
            ...
            function h(t, e, i) {
                ...
                return (
                    e &&
                        ...
                        m.initProps(f, { shape: { width: h, height: c } }, i)),
                    f
                );
            }
            function c(t, e, i) {
        ...
        function (t, e, i) {
            ...
            function r(t, e, i, r, o, a, g, m, v, y, x) {
                for (var _ = 0, b = i, w = 0; r > w; w++) {
                    ...
                    if (b === i)
                        t[a > 0 ? "moveTo" : "lineTo"](M[0], M[1]), u(f, M);
                    else if (v > 0) {
                        var S = b + a,
                            A = e[S];
            ...
            (h.updateData = function (t, e, i) {
                ...
                (h._updateLabel = function (t, e) {
                    ...
                    s.updateProps(
                        ...
                        s.updateProps(n, { style: { x: h.x, y: h.y } }, r, e),
                        n.attr({
                            style: {
        ...
        function (t, e, i) {
            ...
            (o.prototype = { constructor: o, type: "radial" }),
                n.inherits(o, r),
                (t.exports = o);
        },
        function (t, e) {
        ...
        function (t, e, i) {
            ...
            function n(t, e, i) {
                ...
                return null === n || null === r
                    ? [
                          (i ? u : h)(t.x1, t.cpx1, t.cpx2, t.x2, e),
                          (i ? u : h)(t.y1, t.cpy1, t.cpy2, t.y2, e),
                      ]
                    : [
                          (i ? c : l)(t.x1, t.cpx1, t.x2, e),
                          (i ? c : l)(t.y1, t.cpy1, t.y2, e),
                      ];
            }
            var r = i(16),
                o = i(5),
            ...
            function r(t, e, i) {
                ...
                return (
                    ...
                    h([0, 1], function (t) {
                        ...
                        null != n || null == i
                            ? (null == n && (n = a[t]),
                              (i = r.parse(l.linearMap(n, a, e, !0))))
                            : (n = l.linearMap(i, e, a, !0)),
                            (u[t] = i),
                            (s[t] = n);
                    }),
        ...
        function (t, e, i) {
            ...
            function a(t, e, i, r, o, a, s) {
                var l,
                    h = a.coordinateSystem,
                    c = t.getItemModel(e),
                    u = c.get("x"),
                    f = c.get("y");
                if (null != u && null != f)
                    l = [
                        d.parsePercent(u, s.getWidth()),
                        d.parsePercent(f, s.getHeight()),
                    ];
                else {
                    if (a.getMarkerPosition)
                        l = a.getMarkerPosition(t.getValues(t.dimensions, e));
                    else {
                        var p = h.dimensions,
                            g = t.get(p[0], e),
                            m = t.get(p[1], e);
                    ...
                    if (
                        ...
                        m >= 0 && (h = +h.toFixed(m)),
                            ...
                            (n = [
                                f,
                                p,
                                { type: o, valueIndex: n.valueIndex, value: h },
                            ]);
                    }
                    return (
                        (n = [
        ...
        function (t, e, i) {
            ...
            function h(t, e, i, n, r, o, a) {
                ...
                if (
                    ...
                    "function" == typeof t && (t = t([e, i], r, n.el, u)),
                    f.isArray(t))
                )
                    (e = m(t[0], h)), (i = m(t[1], c));
            ...
            i(2).extendComponentView({
                ...
                _showItemTooltipContent: function (t, e, i, n) {
                    ...
                    if (
                        (c.parentModel
                            ? (c.parentModel.parentModel = s)
                            : (c.parentModel = this._tooltipModel),
                        c.get("showContent") && c.get("show"))
                    ) {
                        var u,
                            d = c.get("formatter"),
                            f = c.get("position"),
