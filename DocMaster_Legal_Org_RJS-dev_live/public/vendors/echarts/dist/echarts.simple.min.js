!(function (t, e) {
    ...
    return (function (t) {
        ...
        function (t, e, n) {
                    ...
                    if (I.canvasSupported) {
                        ...
                        if (j[e]) {
                            ...
                            for (var c in H) {
                                var f = H[c];
                                if (f.group === e) {
                                    var d = f.getRenderedCanvas(A.clone(t)),
            ...
            (O.showLoading = function (t, e) {
                ...
                (O.dispatchAction = function (t, e) {
                    ...
                    if (n) {
                        ...
                        t.batch &&
                            ((o = !0),
                            (a = A.map(t.batch, function (e) {
                                return (
                                    (e = A.defaults(A.extend({}, e), t)),
                                    (e.batch = null),
                                    e
                                );
                            })));
            ...
            (Y.init = function (t, e, n) {
                ...
                Y.registerVisualCoding(
                    "echarts",
                    A.curry(n(74), "", "itemStyle"),
                ),
                Y.registerPreprocessor(n(119)),
                Y.registerAction(
                    {
                        type: "highlight",
                        event: "highlight",
        ...
        function (t, e, n) {
            ...
            function r(t) {
                return t instanceof M ? t : _.lift(t, -0.1);
            }
            function a(t) {
                if (t.__hoverStlDirty) {
                    var e = t.style.stroke,
                        n = t.style.fill,
                        a = t.__hoverStl;
                    (a.fill = a.fill || (i(n) ? r(n) : null)),
                        (a.stroke = a.stroke || (i(e) ? r(e) : null));
                    var o = {};
            ...
            function g(t, e, n, i, r, a) {
                ...
                var o = t ? "Update" : "",
                    s = i && i.getShallow("animationDuration" + o),
                    l = i && i.getShallow("animationEasing" + o),
                    h = i && i.getShallow("animationDelay" + o);
                "function" == typeof h && (h = h(r)),
                    i && i.getShallow("animation")
                        ? e.animateTo(n, s, h || 0, l, a)
                        : (e.attr(n), a && a());
            }
            var v = n(1),
                m = n(156),
            ...
            (S.Group = n(27)),
                ...
                (S.BezierCurve = n(146)),
                (S.Arc = n(145)),
                (S.CompoundPath = n(140)),
                (S.LinearGradient = n(76)),
                (S.RadialGradient = n(141)),
                (S.BoundingRect = n(8)),
                ...
                (S.updateProps = v.curry(g, !0)),
                (S.initProps = v.curry(g, !1)),
                (S.getTransform = function (t, e) {
                    for (var n = b.identity([]); t && t !== e; )
                        b.mul(n, t.getLocalTransform(), n), (t = t.parent);
                    return n;
                }),
                (S.applyTransform = function (t, e, n) {
                    return (
                        n && (e = b.invert([], e)), w.applyTransform([], t, e)
                    );
                }),
                ...
                brush: function (t) {
                    ...
                    if (
                        ...
                        s && (this._fillGradient = e.getGradient(t, e.fill, h)),
                            l &&
                                (this._strokeGradient = e.getGradient(
                                    t,
                                    e.stroke,
                                    h,
                                ));
                    ...
                    var u = e.lineDash,
                        c = e.lineDashOffset,
                        f = !!t.setLineDash,
                        d = this.getGlobalScale();
                    n.setScale(d[0], d[1]),
                        this.__dirtyPath || (u && !f && a)
                            ? ((n = this.path.beginPath(t)),
                              u &&
                                  !f &&
                                  (n.setLineDash(u), n.setLineDashOffset(c)),
                              this.buildPath(n, this.shape),
                              (this.__dirtyPath = !1))
                            : (t.beginPath(), this.path.rebuildPath(t)),
                        o && n.fill(t),
                        u && f && (t.setLineDash(u), (t.lineDashOffset = c)),
                        a && n.stroke(t),
                        null != e.text &&
        ...
        function (t, e, n) {
            ...
            (s.createNameEach = function (t, e) {
                ...
                (s.eachAxisDim = s.createNameEach(o, [
                    "axisIndex",
                    "axis",
                    "index",
                ])),
            ...
            (i.prototype = {
                ...
                union: function (t) {
                    ...
                    (this.width = h(t.x + t.width, this.x + this.width) - e),
                        (this.height =
                            h(t.y + t.height, this.y + this.height) - n),
                        (this.x = e),
                        (this.y = n);
                },
            ...
            (u.box = i),
                ...
                (u.getAvailableSize = function (t, e, n) {
                    ...
                    return (
                        ...
                        (isNaN(h) || isNaN(parseFloat(t.x2))) && (h = i),
                ...
                h = o.extend({
                    ...
                    formatTooltip: function (t, e, n) {
                        var r = this._data,
                            ...
                            o = i.isArray(a) ? i.map(a, l).join(", ") : l(a),
                            h = r.getName(t),
                ...
                function r(t, e) {
                    ...
                    for (
                        ...
                        var s = n[o],
                            l = a[s];
                        f.indexOf(e, s) >= 0
                            ? (r[s] = new l.constructor(a[s].length))
                            : (r[s] = a[s]);
                    }
                    return i;
                }
                ...
                (y.type = "list"),
                    ...
                    (y.filterSelf = function (t, e, n, r) {
                        ...
                        for (var h = 0; h < l.length; h++) {
                            var u;
                            if (1 === s) u = e.call(r, this.get(t[0], h, n), h);
                            else {
                                for (var c = 0; s > c; c++)
                                    o[c] = this.get(t[c], h, n);
                                (o[c] = h), (u = e.apply(r, o));
                            }
                            u && a.push(l[h]);
                        }
                    ...
                    (y.getItemModel = function (t) {
                        ...
                        return (
                            (t = this.indices[t]),
                            new u(this._rawData[t], e, e && e.ecModel)
                        );
                    }),
                    (y.diff = function (t) {
                        var e = this._idList,
                    ...
                    (y.wrapMethod = function (t, e) {
                        ...
                        "function" == typeof n &&
                            ...
                            (this[t] = function () {
                                ...
                                return e.apply(
                                    this,
                                    [t].concat(f.slice(arguments)),
                                );
                            }));
                    }),
                    (y.TRANSFERABLE_METHODS = [
                        "cloneShallow",
                        "downSample",
                        "map",
                    ]),
                ...
                if (i(c) && i(f))
                    ...
                    if (i(v)) {
                        ...
                        var A = (2 * c * l - 3 * s * f) / (2 * b(c * c * c)),
                            ...
                            L = Math.cos(C),
                            g = (-l - 2 * I * L) / (3 * s),
                            y = (-l + I * (L + S * Math.sin(C))) / (3 * s),
                            k = (-l + I * (L - S * Math.sin(C))) / (3 * s);
                        g >= 0 && 1 >= g && (o[p++] = g),
                            y >= 0 && 1 >= y && (o[p++] = y),
                            k >= 0 && 1 >= k && (o[p++] = k);
                    }
                        ...
                        d >= 0 && y > g
                            ...
                            : ((I[0] = a(t, n, r, s, p)),
                              ...
                              1 >= p && y > v
                                  ...
                                  : (m *= 0.5));
                return (
                    c && ((c[0] = a(t, n, r, s, f)), (c[1] = a(e, i, o, l, f))),
                    b(y)
                );
            }
            function c(t, e, n, i) {
            ...
            function v(t, e, n, i, r, a, o, s, l) {
                ...
                for (var g = 0; 32 > g && !(M > u); g++) {
                    ...
                    if (v >= 0 && f > p) (h = v), (f = p);
                        ...
                        var y = x(I, A);
                        1 >= m && f > y ? ((h = m), (f = y)) : (u *= 0.5);
                    }
                }
                return (
                    l && ((l[0] = c(t, n, r, h)), (l[1] = c(e, i, a, h))), b(f)
                );
            }
            var m = n(5),
                y = m.create,
        ...
        function (t, e, n) {
            ...
            function s(t, e, n, r) {
                for (var a = 0; ; a++) {
                    ...
                    var s =
                        0 === a ? l(t, n, r) : Math.floor((t.length * n) / o);
            ...
            (h.getScaleExtent = function (t, e) {
                ...
                (h.getAxisLabelInterval = function (t, e, n, i) {
                    ...
                    for (var h = 0; h < t.length; h += s) {
                        var u = t[h],
                            c = l.getBoundingRect(e[h], n, "center", "top");
                        (c[i ? "x" : "y"] += u),
        ...
        function (t, e, n) {
            ...
            (_.prototype = {
                ...
                arc: function (t, e, n, i, r, a) {
                    return (
                        this.addData(l.A, t, e, n, n, i, r - i, 0, a ? 0 : 1),
                ...
                getBoundingRect: function () {
                    ...
                    for (
                        var t = this.data, e = 0, n = 0, i = 0, s = 0, d = 0;
                        d < t.length;
                ...
                v = {
                    ...
                    polar: function (t, e, n) {
                        ...
                        var h = l.get("type"),
                            c = a.get("type"),
                            f = [
                                { name: "radius", type: s(h), stackable: o(h) },
            ...
            var i = n(4),
                ...
                l = a.extend({
                    ...
                    niceExtent: function (t, e, n) {
                        ...
                        e || (r[0] = i.round(o(r[0] / h) * h)),
                            n || (r[1] = i.round(s(r[1] / h) * h));
                    },
                });
            (l.create = function () {
                return new l();
        ...
        function (t, e, n) {
            ...
            (u._updateCommon = function (t, e, n) {
                ...
                if (y) {
                    var x = r.position;
                    (x[0] = h.parsePercent(y[0], n[0])),
                        (x[1] = h.parsePercent(y[1], n[1]));
                }
                ...
                if (
                    ...
                    var C = function () {
                            ...
                            this.animateTo(
                                {
                                    scale: [
                                        Math.max(1.1 * A[0], A[0] + 3),
                                        Math.max(1.1 * A[1], A[1] + 3 * t),
                                    ],
                                },
                                400,
                                "elasticOut",
                        ...
                        if (e.get("axisLabel.show")) {
                            ...
                            for (
                                ...
                                if (!g(a, _, n.labelInterval)) {
                                    ...
                                    (A.eventData = i(e)),
                                        (A.eventData.targetType = "axisLabel"),
                                        (A.eventData.value = T),
                                        y.push(A),
                                        this.group.add(A);
                                }
        ...
        function (t, e, n) {
            ...
            function u(t, e, n, i, r, a, o, s, l) {
                ...
                if (1 == l)
                    ...
                    for (var f = t[0].length, u = 0; h > u; u++)
                        for (var d = 0; f > d; d++)
                            s[u][d] = c(
                                t[u][d],
                                e[u][d],
            ...
            t.exports = {
                buildPath: function (t, e) {
                    ...
                    n + i > l && ((c = n + i), (n *= l / c), (i *= l / c)),
                        ...
                        t.moveTo(o + n, s),
                        t.lineTo(o + l - i, s),
                        0 !== i && t.quadraticCurveTo(o + l, s, o + l, s + i),
                        t.lineTo(o + l, s + h - r),
                        0 !== r &&
                            t.quadraticCurveTo(o + l, s + h, o + l - r, s + h),
                        t.lineTo(o + a, s + h),
                    ...
                    e.extend({
                        ...
                        mergeDefaultAndTheme: function (e, i) {
                            var s = this.layoutMode,
                                ...
                                h = i.getTheme();
                            r.merge(e, h.get(a + "Axis")),
                                r.merge(e, this.getDefaultOption()),
                                (e.type = n(t, e)),
                                s && o.mergeLayoutParam(e, l, s);
                        },
            ...
            (l.prototype = {
                ...
                drawRectText: function (t, e, n) {
                    ...
                    if ((null != l && (l += ""), l)) {
                        ...
                        for (var w = l.split("\n"), M = 0; M < w.length; M++)
                            _ && t.fillText(w[M], h, u),
                                b && t.strokeText(w[M], h, u),
                                (u += n.lineHeight);
                        m && r(t, m);
                    }
                },
        ...
        function (t, e, n) {
            ...
            n(86),
                ...
                r.registerProcessor("statistic", i.curry(n(121), "line")),
                n(36);
        },
        function (t, e, n) {
            "use strict";
            ...
            function u(t, e, n) {
                ...
                return (
                    e &&
                        ...
                        v.initProps(l, { shape: { endAngle: -o[1] * s } }, n)),
                    l
                );
            }
            function c(t, e, n) {
        ...
        function (t, e, n) {
            ...
            function r(t, e, n, r, a, o, g, v, m, y, x) {
                for (var _ = 0, b = n, w = 0; r > w; w++) {
                    ...
                    if (b === n)
                        t[o > 0 ? "moveTo" : "lineTo"](M[0], M[1]), c(d, M);
                    else if (m > 0) {
                        var S = b + o,
                            T = e[S];
                        ...
                        l(d, d, v),
                            ...
                            l(p, p, v),
                            h(p, p, g),
                            t.bezierCurveTo(d[0], d[1], p[0], p[1], M[0], M[1]),
                            u(d, M, f, m * A);
                ...
                Polygon: o.extend({
                    ...
                    buildPath: function (t, e) {
                        var n = e.points,
                            ...
                            l = n.length,
                            h = e.smoothMonotone,
                            u = a(n, e.smoothConstraint),
                            c = a(o, e.smoothConstraint);
                        if (e.connectNulls) {
                            for (; l > 0 && i(n[l - 1]); l--);
                            for (; l > s && i(n[s]); s++);
                        }
        ...
        function (t, e, n) {
            ...
            n(91),
                ...
                r.registerVisualCoding("chart", i.curry(n(64), "pie")),
                r.registerLayout(i.curry(n(94), "pie")),
                r.registerProcessor("filter", i.curry(n(63), "pie"));
        },
        function (t, e, n) {
            "use strict";
            var i = n(15),
            ...
            (h.updateData = function (t, e, n) {
                ...
                (h._updateLabel = function (t, e) {
                    ...
                    s.updateProps(
                        ...
                        s.updateProps(i, { style: { x: h.x, y: h.y } }, r, e),
                        i.attr({
                            style: {
            ...
            t.exports = function (t, e, n, i) {
                ...
                l.each(function (n) {
                    ...
                    var k = g.getModel("textStyle").getFont(),
                        ...
                        D = t.getFormattedLabel(n, "normal") || l.getName(n),
        ...
        function (t, e, n) {
            function i(t, e) {
                ...
                (a.labelDirection = a.tickDirection = a.nameDirection = d[o]),
                    r.onZero && (a.labelOffset = c[l][o] - c[l].onZero),
            ...
            var r = n(1),
                ...
                c = n(2).extendComponentView({
                    ...
                    _splitArea: function (t, e, n) {
                        ...
                        for (var T = h.getAreaStyle(), y = 0; y < g.length; y++)
                            this.group.add(
                                a.mergePath(g[y], {
                                    style: r.defaults(
                                        { fill: u[y % u.length] },
                    ...
                    mergeOption: function (t) {
                        function e(e, r) {
                            ...
                            (n[e] = []),
                                ...
                                "series" === e &&
                                    (this._seriesIndices = l(i.series));
                        }
                        var n = this.option,
            ...
            (i.prototype = {
                ...
                mountOption: function (t) {
                    ...
                    return (
                        ...
                        (this._currentMediaIndices = []),
                        d(t ? e.baseOption : this._newBaseOption)
                    );
                },
            ...
            var i = n(1),
                ...
                g = o.extend({
                    ...
                    niceExtent: function (t, e, n) {
                        ...
                        e || (i[0] = r.round(h(i[0] / o) * o)),
                            n || (i[1] = r.round(l(i[1] / o) * o));
                    },
                    niceTicks: function (t) {
                        t = t || 10;
                        var e = this._extent,
            ...
            (s.prototype = {
                ...
                clear: function (t) {
                    ...
                    if (
                        ...
                        n.clearRect(0, 0, i / l, r / l),
                        a &&
                            (n.save(),
                            (n.fillStyle = this.clearColor),
                            n.fillRect(0, 0, i / l, r / l),
                            n.restore()),
                        o)
                    ) {
                        var h = this.domBack;
            ...
            (m.prototype = {
                ...
                _pathToImage: function (t, e, i, r, a) {
                    ...
                    (e.position = [0, 0, 0]),
                        ...
                        e && e.brush(s);
                    var h = n(46),
                        u = new h({ id: t, style: { x: 0, y: 0, image: o } });
                    return (
                        null != l.position &&
                            (u.position = e.position = l.position),
                        null != l.rotation &&
                            (u.rotation = e.rotation = l.rotation),
        ...
        function (t, e, n) {
            ...
            t.exports = {
                containStroke: function (t, e, n, r, a, o, s, l, h, u, c) {
                    ...
                    var f = h;
                    if (
                        (c > e + f && c > r + f && c > o + f && c > l + f) ||
                        (e - f > c && r - f > c && o - f > c && l - f > c) ||
        ...
        function (t, e, n) {
            ...
            function a(t, e, n, i, a, o, s, l, h, u) {
                ...
                for (var f, d, p = 0, v = -1, m = 0; c > m; m++) {
                    ...
                    h > x ||
                        (0 > v &&
                            ((v = g.cubicExtrema(e, i, o, l, b)),
                            b[1] < b[0] && v > 1 && r(),
                            (f = g.cubicAt(e, i, o, l, b[0])),
                            v > 1 && (d = g.cubicAt(e, i, o, l, b[1]))),
                        (p +=
                            2 == v
                                ? y < b[0]
                                    ? e > f
            ...
            function o(t, e, n, i, r, a, o, s) {
                ...
                if (h >= 0 && 1 >= h) {
                    for (
                        var u = 0, c = g.quadraticAt(e, i, a, h), f = 0;
                        l > f;
                        f++
                    ) {
                        var d = g.quadraticAt(t, n, r, _[f]);
                        o > d ||
                            (u += _[f] < h ? (e > c ? 1 : -1) : c > a ? 1 : -1);
                    }
                    return u;
                }
            ...
            i.prototype = {
                ...
                createLinearGradient: function (t, e, n) {
                    var i = e.x * n.width + n.x,
                        ...
                        a = e.y * n.height + n.y,
                        o = e.y2 * n.height + n.y,
                        s = t.createLinearGradient(i, a, r, o);
                    return s;
                },
                createRadialGradient: function (t, e, n) {
                    var i = n.width,
                        ...
                        s = e.y * r + n.y,
                        l = e.r * a,
                        h = t.createRadialGradient(o, s, 0, o, s, l);
                    return h;
                },
        ...
        function (t, e, n) {
            ...
            t.exports = function (t, e, n, h) {
                ...
                for (var y = 0, x = t.length; x > y; y++) {
                    ...
                    var S = l([], _, v),
                        T = l([], _, m);
                    h && (a(S, S, f), r(S, S, d), a(T, T, f), r(T, T, d)),
                        p.push(S),
                        p.push(T);
                }
            ...
            t.exports = function (t, e) {
                ...
                for (var s = 0; l > s; s++) {
                    ...
                    var v = p * p,
                        m = p * v;
                    a.push([
                        i(h[0], g[0], u[0], c[0], p, v, m),
                        i(h[1], g[1], u[1], c[1], p, v, m),
                    ]);
                }
                return a;
            };
        ...
        function (t, e, n) {
            ...
            function i(t, e, n) {
                ...
                return null === i || null === r
                    ? [
                          (n ? c : h)(t.x1, t.cpx1, t.cpx2, t.x2, e),
                          (n ? c : h)(t.y1, t.cpy1, t.cpy2, t.y2, e),
                      ]
                    : [
                          (n ? u : l)(t.x1, t.cpx1, t.x2, e),
                          (n ? u : l)(t.y1, t.cpy1, t.y2, e),
                      ];
            }
            var r = n(16),
                a = n(5),
