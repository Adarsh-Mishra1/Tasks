    ...
    describe("subPixelOptimize", function () {
        ...
        it("subPixelOptimize_line", function (done) {
            function doSubPixelOptimizeLine(x, y, width, height, lineWidth) {
                return graphic.subPixelOptimizeLine(
                    makeParam(x, y, width, height, lineWidth),
                );
            }
            ...
            expect(doSubPixelOptimizeLine(5, 11, 3, 7, 1)).toEqual(
                makeParam(5, 11, 3, 7, 1),
            );
            expect(doSubPixelOptimizeLine(5, 11, 5, 7, 1)).toEqual(
                makeParam(5.5, 11, 5.5, 7, 1),
            );
            expect(doSubPixelOptimizeLine(5, 11, 5, 7, 2)).toEqual(
                makeParam(5, 11, 5, 7, 2),
            );
            expect(doSubPixelOptimizeLine(5, 11, 15, 11, 1)).toEqual(
                makeParam(5, 11.5, 15, 11.5, 1),
            );
            expect(doSubPixelOptimizeLine(5, 11, 15, 11, 2)).toEqual(
                makeParam(5, 11, 15, 11, 2),
            );
            expect(doSubPixelOptimizeLine(5, 11, 15, 11, 3)).toEqual(
                makeParam(5, 11.5, 15, 11.5, 3),
            );
            expect(doSubPixelOptimizeLine(5, 11, 15, 11.5, 3)).toEqual(
                makeParam(5, 11, 15, 11.5, 3),
            );
            expect(doSubPixelOptimizeLine(5, 11.5, 15, 11.5, 3)).toEqual(
                makeParam(5, 11.5, 15, 11.5, 3),
            );
            expect(doSubPixelOptimizeLine(5, 11.5, 15, 11.5, 4)).toEqual(
                makeParam(5, 12, 15, 12, 4),
            );
            done();
        });
        ...
        it("subPixelOptimize_rect", function (done) {
            function doSubPixelOptimizeRect(x, y, width, height, lineWidth) {
                return graphic.subPixelOptimizeRect(
                    makeParam(x, y, width, height, lineWidth),
                );
            }
            ...
            expect(doSubPixelOptimizeRect(5, 11, 3, 7, 1)).toEqual(
                makeParam(5.5, 11.5, 2, 6, 1),
            );
            expect(doSubPixelOptimizeRect(5, 11, 3, 7, 2)).toEqual(
                makeParam(5, 11, 3, 7, 2),
            );
            expect(doSubPixelOptimizeRect(5, 11, 3, 7, 3)).toEqual(
                makeParam(5.5, 11.5, 2, 6, 3),
            );
            // Boundary value tests
            expect(doSubPixelOptimizeRect(5, 11, 1, 7, 1)).toEqual(
                makeParam(5.5, 11.5, 1, 6, 1),
            );
            expect(doSubPixelOptimizeRect(5, 11, 1, 0, 1)).toEqual(
                makeParam(5.5, 11.5, 1, 0, 1),
            );
            done();
        });
    });
