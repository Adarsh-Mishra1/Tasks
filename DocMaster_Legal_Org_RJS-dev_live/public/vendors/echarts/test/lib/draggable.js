...
(function (global) {
    ...
    global.draggable = {
        ...
        init: function (mainEl, chart, opt) {
            ...
            var borderBoxBroder =
                boxSizing === "border-box" ? 2 * BORDER_WIDTH : 0;
            var mainContentWidth =
                opt.width || mainEl.width() + borderBoxBroder;
            var mainContentHeight =
                opt.height || mainEl.height() + borderBoxBroder;
            ...
            function resize(x, y, isInit) {
                ...
                label.text(
                    Math.round(mainContentWidth) +
                        " x " +
                        Math.round(mainContentHeight),
                );
