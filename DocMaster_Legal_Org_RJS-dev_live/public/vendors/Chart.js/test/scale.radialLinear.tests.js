...
describe("Test the radial linear scale", function () {
	...
	it("Should register the constructor with the scale service", function () {
		var Constructor =
			Chart.scaleService.getScaleConstructor("radialLinear");
	...
	it("Should have the correct default config", function () {
		...
		expect(defaultConfig.pointLabels.callback).toEqual(
	...
	it("Should use the min and max options", function () {
		...
		expect(chartInstance.scale.ticks).toEqual([
			"-1010",
			"-1000",
			"-500",
			"0",
	...
	it("Should build labels using the user supplied callback", function () {
		...
		expect(chartInstance.scale.pointLabels).toEqual([
			"label1",
			"label2",
			"label3",
			"label4",
	...
	it("should get the correct distance from the center point", function () {
		...
		expect(
			chartInstance.scale.getDistanceFromCenterForValue(
				chartInstance.scale.min,
			),
		).toBe(0);
		expect(
			chartInstance.scale.getDistanceFromCenterForValue(
				chartInstance.scale.max,
			),
		).toBe(225);
