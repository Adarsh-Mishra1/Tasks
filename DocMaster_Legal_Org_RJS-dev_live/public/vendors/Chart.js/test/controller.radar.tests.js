...
describe("Radar controller tests", function () {
	...
	it("should update elements", function () {
		...
		[
			...
			expect(meta.data[i]._model.controlPointPreviousX).toBeCloseToPixel(
				expected.cppx,
			);
			expect(meta.data[i]._model.controlPointPreviousY).toBeCloseToPixel(
				expected.cppy,
			);
			expect(meta.data[i]._model.controlPointNextX).toBeCloseToPixel(
				expected.cpnx,
			);
			expect(meta.data[i]._model.controlPointNextY).toBeCloseToPixel(
				expected.cpny,
			);
