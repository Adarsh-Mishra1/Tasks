...
describe("Legend block tests", function () {
	...
	it("should draw correctly", function () {
		...
		[
			...
			expect(chart.legend.legendHitBoxes[i].height).toBeCloseToPixel(
				expected.h,
			);
			expect(chart.legend.legendHitBoxes[i].left).toBeCloseToPixel(
				expected.l,
			);
			expect(chart.legend.legendHitBoxes[i].top).toBeCloseToPixel(
				expected.t,
			);
			expect(chart.legend.legendHitBoxes[i].width).toBeCloseToPixel(
				expected.w,
			);
		});
