...
describe("Test the bubble chart default config", function () {
	it("should reutrn correct tooltip strings", function () {
		...
		expect(config.tooltips.callbacks.label(tooltipItem, data)).toBe(
			"My dataset: (10, 12, 5)",
		);
	});
});
...
describe("Test the doughnut chart default config", function () {
	...
	it("should return the correct html legend", function () {
		...
		var expectedLegend =
			'<ul class="mychart-legend"><li><span style="background-color:red"></span>label1</li><li><span style="background-color:green"></span>label2</li></ul>';
	...
	it("should return correct legend label objects", function () {
		...
		expect(
			config.legend.labels.generateLabels.call({ chart: chart }, data),
		).toEqual(expected);
	});
...
describe("Test the polar area chart default config", function () {
	...
	it("should return the correct html legend", function () {
		...
		var expectedLegend =
			'<ul class="mychart-legend"><li><span style="background-color:red">label1</span></li><li><span style="background-color:green">label2</span></li></ul>';
