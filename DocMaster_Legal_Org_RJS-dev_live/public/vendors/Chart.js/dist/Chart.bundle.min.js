			...
			function (t, e, i) {
				...
				(o.prototype = {
					...
					(o.prototype.setValues = function (t, e) {
						...
						var h;
						for (i = 0; i < t.length; i++)
							(h = Math.max(0, Math.min(r[t][i], a[t][i]))),
								(a[t][i] = Math.round(h));
			...
			function (t, e, i) {
				...
				function R(t) {
					...
					return (
						...
						(i = a * -0.9689 + 1.8758 * o + 0.0415 * r),
						(n = 0.0557 * a + o * -0.204 + 1.057 * r),
						(e =
							e > 0.0031308
			...
			function (t, e, i) {
				!(function (t, n) {
					...
					function m(t, e) {
						var i, n, a;
						if (
							(g(e._isAMomentObject) ||
								(t._isAMomentObject = e._isAMomentObject),
							g(e._i) || (t._i = e._i),
							g(e._f) || (t._f = e._f),
							g(e._l) || (t._l = e._l),
							g(e._strict) || (t._strict = e._strict),
							g(e._tzm) || (t._tzm = e._tzm),
							g(e._isUTC) || (t._isUTC = e._isUTC),
							g(e._offset) || (t._offset = e._offset),
							g(e._pf) || (t._pf = u(e)),
							g(e._locale) || (t._locale = e._locale),
							dn.length > 0)
						)
							for (i in dn)
								(n = dn[i]), (a = e[n]), g(a) || (t[n] = a);
						return t;
					}
					function p(t) {
						m(this, t),
					...
					function _(t, e) {
						...
						return l(function () {
							return (
								null != i.deprecationHandler &&
									i.deprecationHandler(null, t),
								n &&
									(k(
										t +
											"\nArguments: " +
					...
					function F(i) {
						var n = null;
						if (!pn[i] && "undefined" != typeof e && e && e.exports)
							try {
							...
							? ((e.abbr = t),
								null != pn[t]
									? (S(
										...
										(e = D(pn[t]._config, e)))
									: null != e.parentLocale &&
										(null != pn[e.parentLocale]
											? (e = D(
													pn[e.parentLocale]._config,
													e,
												))
											: S(
					...
					function R(t, e) {
						if (null != e) {
							...
							null != pn[t] &&
								(null != pn[t].parentLocale
									? (pn[t] = pn[t].parentLocale)
									: null != pn[t] && delete pn[t]);
						return pn[t];
					}
					function W(t) {
						var e;
					...
					function z(t) {
						var e,
							...
							n = {};
						for (i in t)
							s(t, i) && ((e = B(i)), e && (n[e] = t[i]));
						return n;
					}
					function Y(t, e) {
						return function (n) {
							return null != n
								? (N(this, t, n), i.updateOffset(this, e), this)
								: H(this, t);
						};
					}
					function H(t, e) {
					...
					function J(t, e) {
						...
						var n = 5;
						for (yn.lastIndex = 0; n >= 0 && yn.test(t); )
							(t = t.replace(yn, i)),
								(yn.lastIndex = 0),
								(n -= 1);
						return t;
					...
					function rt(t, e, i) {
						...
						return i
							? "MMM" === e
								? ((a = mn.call(this._shortMonthsParse, r)),
									-1 !== a ? a : null)
								: ((a = mn.call(this._longMonthsParse, r)),
									-1 !== a ? a : null)
							: "MMM" === e
								? ((a = mn.call(this._shortMonthsParse, r)),
									-1 !== a
					...
					function ut(t) {
						return this._monthsParseExact
							? (s(this, "_monthsRegex") || ft.call(this),
								t
					...
					function ft() {
						...
						for (
							n.sort(t), a.sort(t), o.sort(t), e = 0;
							12 > e;
							e++
						)
							(n[e] = K(n[e])),
												...
												: i[jn] < 0 || i[jn] > 59
													...
													: i[Gn] < 0 || i[Gn] > 59
														...
														: i[qn] < 0 ||
															...
															? qn
															: -1),
								u(t)._overflowDayOfYear &&
									(Hn > e || e > En) &&
									(e = En),
								u(t)._overflowWeeks && -1 === e && (e = Zn),
								u(t)._overflowWeekday && -1 === e && (e = Jn),
								(u(t).overflow = e)),
							t
						);
					}
							...
							for (
								n = Dt(t),
									...
									t._dayOfYear &&
										...
										(i = vt(a, 0, t._dayOfYear)),
										(t._a[Nn] = i.getUTCMonth()),
										(t._a[En] = i.getUTCDate())),
									e = 0;
								3 > e && null == t._a[e];
								++e
							)
					...
					function At(t) {
						...
						var e,
							...
							h = 0;
						for (
							a = J(t._f, t._locale).match(vn) || [], e = 0;
							e < a.length;
							e++
						)
							(o = a[e]),
						...
						return (
							this._tzm
								...
								: "string" == typeof this._i &&
									this.utcOffset(jt(Wn, this._i)),
							this
						);
					}
					function Kt(t) {
						return this.isValid()
							? ((t = t ? Bt(t).utcOffset() : 0),
					...
					function ue(t, e, n, a) {
						...
						t.isValid() &&
							...
							r && N(t, "Date", H(t, "Date") + r * n),
							s && lt(t, H(t, "Month") + s * n),
							a && i.updateOffset(t, r || s));
					}
					function ce(t, e) {
						var i = t || Bt(),
							...
							r = e && (w(e[o]) ? e[o]() : e[o]);
						return this.format(
							r || this.localeData().calendar(o, this, Bt(i)),
						);
					}
					function fe() {
						return new p(this);
					...
					function ri(t, e, i) {
						...
						return i
							? "dddd" === e
								? ((a = mn.call(this._weekdaysParse, r)),
									-1 !== a ? a : null)
								: "ddd" === e
									? ((a = mn.call(
											this._shortWeekdaysParse,
										...
										-1 !== a ? a : null)
									: ((a = mn.call(this._minWeekdaysParse, r)),
										-1 !== a ? a : null)
							: "dddd" === e
								? ((a = mn.call(this._weekdaysParse, r)),
									-1 !== a
					...
					function ui(t) {
						return this._weekdaysParseExact
							? (s(this, "_weekdaysRegex") || gi.call(this),
								t
					...
					function Xi(t) {
						...
						switch (
							((e = this._days + Math.round(Ji(this._months))), t)
						) {
							case "week":
								return e / 7 + n / 6048e5;
							case "day":
					...
					(i.createFromInputFallback = _(
						...
						tt("YYYY", function (t, e) {
							e[Hn] =
								2 === t.length ? i.parseTwoDigitYear(t) : y(t);
						}),
						tt("YY", function (t, e) {
						...
						(t.controllers.bar = t.DatasetController.extend({
							...
							getRuler: function (t) {
								...
								var o = e * n.options.categoryPercentage,
									r =
										(e - e * n.options.categoryPercentage) /
										2,
									s = o / a;
								if (
									n.ticks.length !==
							...
							calculateBarY: function (t, e) {
								...
								if (n.options.stacked) {
									...
									return 0 > a
										? n.getPixelForValue(r + a)
										: n.getPixelForValue(o + a);
								}
								return n.getPixelForValue(a);
							},
							draw: function (t) {
						...
						(t.controllers.doughnut = t.controllers.pie =
							t.DatasetController.extend({
								...
								updateElement: function (t, i, n) {
									...
									var x = t._model;
									(x.backgroundColor = v.backgroundColor
										? v.backgroundColor
										: y(
												g.backgroundColor,
												i,
								...
								for (t = 0, i = l.length; i > t; ++t)
									(n = l[t]),
										...
										(a.controlPointPreviousX = Math.max(
											Math.min(o.previous.x, s.right),
											s.left,
										)),
										(a.controlPointPreviousY = Math.max(
											Math.min(o.previous.y, s.bottom),
											s.top,
										)),
										(a.controlPointNextX = Math.max(
											Math.min(o.next.x, s.right),
											s.left,
										)),
										(a.controlPointNextY = Math.max(
											Math.min(o.next.y, s.bottom),
											s.top,
										)),
										n.pivot();
							},
						...
						(t.controllers.polarArea = t.DatasetController.extend({
							...
							update: function (t) {
								...
								(n.outerRadius = Math.max(
									...
									(i.outerRadius =
										n.outerRadius -
										n.radiusLength * i.index),
									(i.innerRadius =
										i.outerRadius - n.radiusLength),
									(o.count = i.countVisibleElements()),
									e.each(o.data, function (e, n) {
										i.updateElement(e, n, t);
									});
							},
							updateElement: function (t, i, n) {
								for (
									var a = this,
										...
										g = o.data.labels,
										m = a.calculateCircumference(s.data[i]),
										p = (r.left + r.right) / 2,
										b = (r.top + r.bottom) / 2,
										v = 0,
										y = a.getMeta(),
									...
									isNaN(s.data[x]) || y.data[x].hidden || ++v;
								var k = t.hidden
										? 0
										: c.getDistanceFromCenterForValue(
												s.data[i],
											),
									_ = -0.5 * Math.PI + m * v,
									S = _ + (t.hidden ? 0 : m),
							...
							updateBezierControlPoints: function () {
								...
								e.each(
									...
									function (n, a) {
										var o = n._model,
											r = e.splineCurve(
												e.previousItem(i.data, a, !0)
													._model,
												o,
												e.nextItem(i.data, a, !0)
													._model,
												o.tension,
											);
							...
							resize: function (t) {
								var i = this.chart.canvas,
									...
									o =
										...
										this.chart.height !== a;
								return o
									? ((i.width = this.chart.width = n),
										(i.height = this.chart.height = a),
							...
							eventHandler: function (t) {
								...
								return (
									...
									i.animating ||
										...
										(i.stop(),
										(r.enabled || r.custom) && n.update(!0),
										i.render(o.animationDuration, !0)),
							...
							removeHoverStyle: function (t, i) {
								...
								(s.backgroundColor = o.backgroundColor
									...
									(s.borderColor = o.borderColor
										? o.borderColor
										: r(n.borderColor, a, i.borderColor)),
									(s.borderWidth = o.borderWidth
										? o.borderWidth
										: r(n.borderWidth, a, i.borderWidth));
							},
							setHoverStyle: function (t) {
								var i =
										this.chart.data.datasets[
			...
			function (t, e, i) {
				...
				e.exports = function (t) {
					...
					function a(t, n, a) {
						...
						return h || d
							? Math.min(h ? e(s, t, a) : u, d ? e(l, r, a) : u)
							: "none";
					}
					var o = (t.helpers = {});
					...
					t.layoutService = {
						...
						update: function (t, i, n) {
							function a(t) {
								...
								i
									? ((e = t.update(
											t.options.fullWidth ? m : k,
											x,
										)),
										(_ -= e.height))
									: ((e = t.update(y, v)), (k -= e.width)),
									S.push({
										horizontal: i,
										minSize: e,
										box: t,
					...
					(t.defaults.scale = {
						...
						(t.Scale = t.Element.extend({
							...
							calculateTickRotation: function () {
								...
								if (
									((this.labelRotation = a.minRotation || 0),
									(this.paddingRight = 0),
									(this.paddingLeft = 0),
									...
									for (
										var c,
											...
											p =
												...
												6;
										m > p &&
										this.labelRotation < a.maxRotation;
										...
										if (
											...
											(h = c * d),
											h + o / 2 > this.yLabelWidth &&
												(this.paddingLeft = h + o / 2),
											(this.paddingRight = o / 2),
											f * g > this.maxHeight)
										) {
											this.labelRotation--;
											break;
								...
								if (
									...
									if (l) {
										...
										(i.height = Math.min(
											...
											(this.ctx.font = c);
										var y = this.ctx.measureText(
												this.ticks[0],
											).width,
											x = this.ctx.measureText(
												this.ticks[
													this.ticks.length - 1
												],
											).width,
							...
							draw: function (i) {
								...
								if (n.display) {
									...
									if (
										((h.fillStyle = p), this.isHorizontal())
									) {
										a = !0;
										var A =
												"bottom" === n.position
					...
					t.Title = t.Element.extend({
						...
						draw: function () {
							...
							if (o.display) {
								var s,
									l,
									h = a(o.fontSize, r.defaultFontSize),
					...
					(t.defaults.global.tooltips = {
						...
						(t.Tooltip = t.Element.extend({
							...
							getAveragePosition: function (t) {
								...
								for (var a = 0, o = 0, r = 0; r < e.length; r++)
									(a += e[r]), (o += n[r]);
								return {
						...
						n = t.Scale.extend({
							determineDataLimits: function () {
								...
								var i = this,
									...
									l = i.isHorizontal();
								if (
									((i.min = null), (i.max = null), n.stacked)
								) {
									var h = {},
										d = !1,
										u = !1;
							...
							buildTicks: function () {
								...
								var f = Math.floor(n.min / d) * d,
									...
									m = (g - f) / d;
								(m = e.almostEquals(m, Math.round(m), d / 1e3)
									? Math.round(m)
									: Math.ceil(m)),
							...
							getPixelForValue: function (t, e, i, n) {
								...
								return r.isHorizontal()
									? ((o = r.width - (s + r.paddingRight)),
										(a = r.left + (o / u) * (d - h)),
										Math.round(a + s))
									: ((o = r.height - (r.paddingTop + l)),
										(a = r.bottom - l - (o / u) * (d - h)),
										Math.round(a));
							},
							getValueForPixel: function (t) {
								var e = this,
						...
						a = t.Scale.extend({
							...
							setDimensions: function () {
								...
								this.drawingArea = t.display
									? n / 2 - (a / 2 + t.ticks.backdropPaddingY)
									: n / 2;
							},
							determineDataLimits: function () {
								if (
								...
								determineDataLimits: function () {
									...
									this.chart.data.labels.length > 0
										? (e.each(
											...
											(this.firstTick = n.min.call(
												this,
												t,
											)),
											(this.lastTick = n.max.call(
												this,
												t,
											)))
										: ((this.firstTick = null),
