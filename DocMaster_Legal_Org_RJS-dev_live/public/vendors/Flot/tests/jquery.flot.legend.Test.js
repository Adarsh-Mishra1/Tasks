...
describe("flot legend plugin", function () {
  ...
  positions.forEach(function (pos) {
    it(
      "shold draw a legend over graph at cardinal position: " +
        pos +
        ", if a container is not provided",
      function () {
  ...
  it("should assign a default plot label if none is provided", function () {
    ...
    var firstLegendEntry = legendSvg.getElementsByTagNameNS(
      "http://www.w3.org/2000/svg",
      "g",
    )[0];
    var entryLabel = firstLegendEntry.getElementsByTagNameNS(
      "http://www.w3.org/2000/svg",
      "text",
    )[0];
