  ...
  function Plot(placeholder, data_, options_, plugins) {
    ...
    function computeBarWidth(series) {
      var pointsize = series.datapoints.pointsize,
        ...
        distance =
          series.datapoints.points[pointsize] - series.datapoints.points[0] ||
          1;
      ...
      for (
        var j = pointsize;
        j < series.datapoints.points.length - pointsize;
        j += pointsize
      ) {
        distance = Math.abs(
          series.datapoints.points[pointsize + j] - series.datapoints.points[j],
        );
