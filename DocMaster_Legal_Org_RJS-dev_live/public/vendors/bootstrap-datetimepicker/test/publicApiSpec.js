describe("Plugin initialization and component basic construction", function () {
  ...
  it("creates the component with default options merged with those provided on an input element", function () {
    ...
    expect(dtp.options()).toEqual(
      $.extend(true, {}, dtpElement.datetimepicker.defaults, options),
    );
  });
  ...
  xit("calls destroy when Element that the component is attached is removed", function () {
    var dtpElement = $("<div>")
        .attr("class", "row")
        .append($("<div>").attr("class", "col-md-12").append($("<input>"))),
      dtp;
    $(document).find("body").append(dtpElement);
...
describe("Public API method tests", function () {
  ...
  beforeEach(function () {
    ...
    $(document)
      ...
      .append(
        $("<div>")
          .attr("class", "row")
          .append($("<div>").attr("class", "col-md-12").append(dtpElement)),
      );
  ...
  describe("configuration option name match to public api function", function () {
    Object.getOwnPropertyNames($.fn.datetimepicker.defaults).forEach(
      function (key) {
  ...
  describe("show() function", function () {
    ...
    describe("functionality", function () {
      ...
      it("actually shows the widget", function () {
        dtp.show();
        expect(
          $(document).find("body").find(".bootstrap-datetimepicker-widget")
            .length,
        ).toEqual(1);
      });
      ...
      it("applies the styles appended in the classify event handler", function () {
        ...
        expect(
          $(document)
            .find("body")
            .find(".bootstrap-datetimepicker-widget td.day.injected").length,
        ).toEqual(42);
        expect(
          $(document)
            .find("body")
            .find(".bootstrap-datetimepicker-widget td.day.humpday").length,
        ).toEqual(6);
      });
    });
  ...
  describe("options() function", function () {
    ...
    describe("access", function () {
      it("gets options", function () {
        expect(dtpElement.datetimepicker("options")).toEqual(
          dtpElement.datetimepicker.defaults,
        );
      });
  ...
  describe("disabledDates() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets disabled dates", function () {
        ...
        expect(dtpElement.datetimepicker("disabledDates", timestamps)).toBe(
          dtpElement,
        );
  ...
  describe("enabledDates() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets enabled dates", function () {
        var timestamps = [moment()];
        expect(dtpElement.datetimepicker("enabledDates", timestamps)).toBe(
          dtpElement,
        );
  ...
  describe("daysOfWeekDisabled() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets days of week disabled", function () {
        var daysOfWeek = [0];
        expect(
          dtpElement.datetimepicker("daysOfWeekDisabled", daysOfWeek),
        ).toBe(dtpElement);
        expect(dtpElement.datetimepicker("daysOfWeekDisabled")).toEqual(
          daysOfWeek,
        );
  ...
  describe("maxDate() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets max date", function () {
        var timestamp = moment();
        expect(dtpElement.datetimepicker("maxDate", timestamp)).toBe(
          dtpElement,
        );
        expect(dtpElement.datetimepicker("maxDate").isSame(timestamp)).toBe(
          true,
        );
      });
    });
  ...
  describe("minDate() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets min date", function () {
        var timestamp = moment();
        expect(dtpElement.datetimepicker("minDate", timestamp)).toBe(
          dtpElement,
        );
        expect(dtpElement.datetimepicker("minDate").isSame(timestamp)).toBe(
          true,
        );
      });
    });
  ...
  describe("defaultDate() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets default date", function () {
        var timestamp = moment();
        expect(dtpElement.datetimepicker("defaultDate", timestamp)).toBe(
          dtpElement,
        );
        expect(dtpElement.datetimepicker("defaultDate").isSame(timestamp)).toBe(
          true,
        );
      });
    });
  ...
  describe("useCurrent() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets use current", function () {
        ...
        expect(dtpElement.datetimepicker("useCurrent", useCurrent)).toBe(
          dtpElement,
        );
  ...
  describe("ignoreReadonly() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets ignore readonly", function () {
        ...
        expect(
          dtpElement.datetimepicker("ignoreReadonly", ignoreReadonly),
        ).toBe(dtpElement);
        expect(dtpElement.datetimepicker("ignoreReadonly")).toBe(
          ignoreReadonly,
        );
      });
    });
  ...
  describe("stepping() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets stepping", function () {
        var stepping = 2;
        expect(dtpElement.datetimepicker("stepping", stepping)).toBe(
          dtpElement,
        );
  ...
  describe("collapse() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets collapse", function () {
        var collapse = false;
        expect(dtpElement.datetimepicker("collapse", collapse)).toBe(
          dtpElement,
        );
  ...
  describe("icons() function", function () {
    ...
    describe("access", function () {
      it("gets icons", function () {
        expect(dtpElement.datetimepicker("icons")).toEqual(
          dtpElement.datetimepicker.defaults.icons,
        );
      });
      ...
      it("sets icons", function () {
        ...
        expect(dtpElement.datetimepicker("icons")).toEqual(
          $.extend(true, {}, dtpElement.datetimepicker.defaults.icons, icons),
        );
      });
    });
  });
  ...
  describe("useStrict() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets use strict", function () {
        var useStrict = true;
        expect(dtpElement.datetimepicker("useStrict", useStrict)).toBe(
          dtpElement,
        );
  ...
  describe("sideBySide() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets side-by-side", function () {
        var sideBySide = true;
        expect(dtpElement.datetimepicker("sideBySide", sideBySide)).toBe(
          dtpElement,
        );
  ...
  describe("viewMode() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets view mode", function () {
        var viewMode = "years";
        expect(dtpElement.datetimepicker("viewMode", viewMode)).toBe(
          dtpElement,
        );
  ...
  describe("widgetPositioning() function", function () {
    ...
    describe("access", function () {
      it("gets widget positioning", function () {
        expect(dtpElement.datetimepicker("widgetPositioning")).toEqual(
          dtpElement.datetimepicker.defaults.widgetPositioning,
        );
      });
      ...
      it("sets widget positioning", function () {
        ...
        expect(
          dtpElement.datetimepicker("widgetPositioning", widgetPositioning),
        ).toBe(dtpElement);
        expect(dtpElement.datetimepicker("widgetPositioning")).toEqual(
          $.extend(
            true,
  ...
  describe("calendarWeeks() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets calendar weeks", function () {
        ...
        expect(dtpElement.datetimepicker("calendarWeeks", calendarWeeks)).toBe(
          dtpElement,
        );
  ...
  describe("showTodayButton() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets show today button", function () {
        ...
        expect(
          dtpElement.datetimepicker("showTodayButton", showTodayButton),
        ).toBe(dtpElement);
        expect(dtpElement.datetimepicker("showTodayButton")).toBe(
          showTodayButton,
        );
      });
    });
  ...
  describe("showClear() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets show clear", function () {
        var showClear = true;
        expect(dtpElement.datetimepicker("showClear", showClear)).toBe(
          dtpElement,
        );
  ...
  describe("dayViewHeaderFormat() function", function () {
    ...
    describe("access", function () {
      it("gets day view header format", function () {
        expect(dtpElement.datetimepicker("dayViewHeaderFormat")).toBe(
          "MMMM YYYY",
        );
      });
      ...
      it("sets day view header format", function () {
        ...
        expect(
          dtpElement.datetimepicker("dayViewHeaderFormat", dayViewHeaderFormat),
        ).toBe(dtpElement);
        expect(dtpElement.datetimepicker("dayViewHeaderFormat")).toBe(
          dayViewHeaderFormat,
        );
  ...
  describe("extraFormats() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets extra formats", function () {
        ...
        expect(dtpElement.datetimepicker("extraFormats", extraFormats)).toBe(
          dtpElement,
        );
  ...
  describe("toolbarPlacement() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets toolbar placement", function () {
        ...
        expect(
          dtpElement.datetimepicker("toolbarPlacement", toolbarPlacement),
        ).toBe(dtpElement);
        expect(dtpElement.datetimepicker("toolbarPlacement")).toBe(
          toolbarPlacement,
        );
      });
    });
  ...
  describe("widgetParent() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets widget parent", function () {
        expect(dtpElement.datetimepicker("widgetParent", "testDiv")).toBe(
          dtpElement,
        );
  ...
  describe("keepOpen() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets keep open", function () {
        var keepOpen = true;
        expect(dtpElement.datetimepicker("keepOpen", keepOpen)).toBe(
          dtpElement,
        );
  ...
  describe("keyBinds() function", function () {
    ...
    describe("access", function () {
      it("gets key binds", function () {
        expect(dtpElement.datetimepicker("keyBinds")).toEqual(
          dtpElement.datetimepicker.defaults.keyBinds,
        );
      });

      it("sets key binds", function () {
        var keyBinds = { up: function () {} };
        expect(dtpElement.datetimepicker("keyBinds", keyBinds)).toBe(
          dtpElement,
        );
  ...
  describe("parseInputDate() function", function () {
    ...
    describe("access", function () {
      ...
      it("sets parse input date", function () {
        ...
        expect(
          dtpElement.datetimepicker("parseInputDate", parseInputDate),
        ).toBe(dtpElement);
        expect(dtpElement.datetimepicker("parseInputDate")).toBe(
          parseInputDate,
        );
      });
    });
  ...
  describe("Time zone tests", function () {
    function makeFormatTest(format, displayTimeZone) {
      it(
        "should not change the value that was set when using format " + format,
        function () {
          // #1326
