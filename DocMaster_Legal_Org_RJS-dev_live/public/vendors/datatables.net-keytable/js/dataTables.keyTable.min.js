...
(function (e) {
    ...
    _focus: function (a, b, d) {
      ...
      if (this.s.enable) {
        ...
        if (-1 !== i.length && (a < i.start || a >= i.start + i.length))
          ...
          if (d === n || !0 === d)
            this._scroll(e(k), e(g.body), m, "offset"),
              (d = f.table().body().parentNode),
              d !== f.table().header().parentNode &&
                ((d = e(d.parentNode)), this._scroll(d, d, m, "position"));
          this.s.lastFocus = i;
        ...
        "right" === b
          ...
          : "left" === b
            ...
            : "up" === b
              ? h--
              : "down" === b && h++;
        0 <= h && h < i && -1 !== e.inArray(f, j)
          ? (a.preventDefault(), this._focus(h, f))
          : !d || !this.c.blurable
            ? a.preventDefault()
            : this._blur();
      }
  ...
  h.ext.selector.cell.push(function (a, b, d) {
    ...
    for (var e = 0, g = d.length; e < g; e++)
      ((!0 === b && a.focused(d[e])) || (!1 === b && !a.focused(d[e]))) &&
        c.push(d[e]);
    return c;
  });
